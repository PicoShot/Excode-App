...
const ExSulaleList = ({ items }) => {
  ...
  return (
    <ScrollView horizontal>
      <DataTable>
        <DataTable.Header>
          <DataTable.Title style={styles.header}>YAKINLIK</DataTable.Title>
...
const styles = StyleSheet.create({
  ...
  cell: {
    ...
    alignItems: "center", // Align items to the start to allow text wrapping
